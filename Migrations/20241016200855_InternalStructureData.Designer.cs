...
namespace IAutor.Api.Migrations
{
    ...
    [Migration("20241016200855_InternalStructureData")]
    partial class InternalStructureData
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("IAutor.Api.Data.Entities.BookDegust", b =>
                {
                    b.Property<long>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("bigint")
                    ...
                    b.ToTable("book_degusts", (string)null);
                });
            ...
            modelBuilder.Entity("IAutor.Api.Data.Entities.Question", b =>
                {
                    ...
                    b.HasOne("IAutor.Api.Data.Entities.Theme", "Theme")
                        .WithMany("Questions")
